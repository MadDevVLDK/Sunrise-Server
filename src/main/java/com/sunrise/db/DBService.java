...
import com.sunrise.db.repository.*;
...
public class DBService {
    ...
    // Основные методы
    public void saveGroupChat(@NonNull Chat chat, @NonNull Long[] membersWithoutCreatorIds) {
    ...
    public void savePersonalChat(@NonNull Chat chat, long opponentId) {
    ...
    // Основные методы
    public void upsertChatMember(@NonNull ChatMember chatMember) {
    ...
    // Основные методы
    public void saveVerificationToken(@NonNull VerificationToken token) {
        tokenRepository.save(token);
    }
    public void deleteVerificationToken(@NonNull String token) {
        tokenRepository.deleteByToken(token);
    }
    public Optional<VerificationToken> getVerificationToken(@NonNull String token) {
    ...
    // Основные методы
    public void saveLoginHistory(@NonNull LoginHistory loginHistory) {
